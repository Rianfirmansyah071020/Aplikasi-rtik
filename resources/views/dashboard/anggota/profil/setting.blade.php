...
<form action="/dashboard/anggota/profil/setting" method="post" enctype="multipart/form-data">
    @method('put')
    @csrf
...
<div class="row d-lg-flex justify-content-lg-center mt-1">
    <div class="col-lg-5 col-12 card p-4 m-2">
        <div class="mt-2">
            ...
            <input type="email" name="email" id="email" class="form-control @error('email') is-invalid @enderror" placeholder="masukan email" value="{{ $user->email }}" required>
            @error('email')
        ...
        <div class="mt-2 mb-2">
            ...
            <input type="password" name="password" id="password" value="{{ $user->password }}" class="form-control @error('password') is-invalid @enderror" placeholder="masukan password baru anda" required>
            @error('password')
                <div class="alert alert-danger">{{ $message }}</div>
            @enderror
        </div>
    ...
    <div class="col-lg-5 col-12 card p-4 m-2">
        <div>
            ...
            <input type="date" name="tgl_th_lahir" id="tgl_th_lahir" value="{{ $data->tgl_th_lahir }}" class="form-control @error('tgl_th_lahir') is-invalid @enderror" placeholder="masukan tgl_th_lahir" value="{{ $data->tgl_th_lahir }}" required>
            @error('tgl_th_lahir')
                <div class="alert alert-danger">
                    {{ $message }}
                </div>
